...
<body>
	...
	<header>
		...
		<div class="menu">
			<ul>
				<li class="logo"><a href="https://netfin.knoxxbox.in/ws">
				...
				<li class="menu-item hidden"><a href="#">Contribute</a>
				</li>
			</ul>
		</div>
		...
		<div class="heroe">
			...
			<h1>Welcome to NetFin 1.0.0</h1>

			<h2>The Small Business Accounting Application</h2>
	...
	<section>
		...
		<p>Web Service for NetFin Accounting Application, a simple Double Entry based account management system for small scale businesses. This web service will be consumed by Flutter Web application.</p>
	...
	<footer>
		...
		<div class="copyrights">
			...
			<p>&copy; <?= date('Y') ?> RSoft. NetFin is open source project released under the MIT
